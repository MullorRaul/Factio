...
// Interfaz para la estructura de un evento (misma interfaz que para Delirium)
interface Event {
    id: string;
    name: string;
    description: string;
...
// Datos de ejemplo para los eventos de Gaudi
const GAUDI_EVENTS: Event[] = [
    {
        id: 'g-jue-1',
        name: 'Electrónica Experimental',
        description: 'Noche de sonidos vanguardistas y ritmos únicos.',
        day: 'Jueves',
        photo: require('../assets/images/Gaudi.jpg'), // <-- PATH CORREGIDO A ../../
        time: '23:00h',
        entryPrice: 'Gratis',
    },
    {
        id: 'g-vie-1',
        name: 'Techno Party',
        description: 'La mejor selección de techno underground.',
        day: 'Viernes',
        photo: require('../assets/images/Gaudi.jpg'), // <-- PATH CORREGIDO A ../../
        time: '00:00h',
    ...
    {
        id: 'g-vie-2',
        name: 'Visuales y Ambient',
        description: 'Sesión con visuales impactantes y música ambient.',
        day: 'Viernes',
        photo: require('../assets/images/Gaudi.jpg'), // <-- PATH CORREGIDO A ../../
        time: '02:00h',
        entryPrice: '10€ con consumición', // Mismo precio si entras más tarde
    },
    {
        id: 'g-sab-1',
        name: 'House Session',
        description: 'Grooves de house y deep house toda la noche.',
        day: 'Sábado',
        photo: require('../assets/images/Gaudi.jpg'), // <-- PATH CORREGIDO A ../../
        time: '23:30h',
        entryPrice: '12€ con consumición',
    },
    {
        id: 'g-sab-2',
        name: 'DJ Residente',
        description: 'El DJ residente de Gaudi con su set especial.',
        day: 'Sábado',
        photo: require('../assets/images/Gaudi.jpg'), // <-- PATH CORREGIDO A ../../
        time: '01:00h',
        entryPrice: '12€ con consumición',
    ...
    {
        id: 'g-dom-1',
        name: 'Chill Out Sunday',
        description: 'Relájate con música suave y ambiente tranquilo.',
        day: 'Domingo',
        photo: require('../assets/images/Gaudi.jpg'), // <-- PATH CORREGIDO A ../../
        time: '19:00h',
        entryPrice: 'Gratis',
...
// Días de la semana en el orden que queremos mostrarlos (mismos días)
const DAYS_OF_WEEK: ('Jueves' | 'Viernes' | 'Sábado' | 'Domingo')[] = ['Jueves', 'Viernes', 'Sábado', 'Domingo'];

export default function EventosGaudiScreen() {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.headerBar}>
                ...
                <Text style={styles.title}>Eventos Gaudi</Text> {/* Título específico */}
            </View>

            <ScrollView contentContainerStyle={styles.scrollViewContent}>
                {DAYS_OF_WEEK.map(day => {
                    // Filtrar eventos para el día actual
                    const eventsToday = GAUDI_EVENTS.filter(event => event.day === day);
