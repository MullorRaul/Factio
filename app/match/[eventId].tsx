...
const allLocalParticipantsData: EventParticipants = {
    1006: [ // Evento existente
        ...
        },
        {
            ...
            username: 'dortega_event1007',
            edad: 33,
            genero: 'masculino',
            orientacion_sexual: 'heterosexual',
            url_fotoperfil: 'https://images.unsplash.com/photo-1540569014015-19a7be504e3a?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80',
            foto_url_1: 'https://images.unsplash.com/photo-1540569014015-19a7be504e3a?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80',
            foto_url_2: null,
            bio: 'Ingeniero ambiental comprometido con la sostenibilidad. Nuevo en Evento Sigma.',
            intereses: 'Medio Ambiente, Senderismo, Fotografía Natural',
            estudios_trabajo: 'Ingeniero Ambiental'
        },
        {
            cod_usuario: 706,
            nombre: 'Hugo Martínez',
            username: 'hmartinez_event1007',
            edad: 28,
            genero: 'masculino',
            orientacion_sexual: 'homosexual',
            url_fotoperfil: 'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80',
            foto_url_1: 'https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80',
            foto_url_2: null,
            bio: 'Diseñador de moda urbana con pasión por la cultura streetwear.',
            intereses: 'Moda, Arte Urbano, Skateboarding',
            estudios_trabajo: 'Diseñador de Moda'
        },
        {
            cod_usuario: 707,
            nombre: 'Adrián Castillo',
            username: 'acastillo_event1007',
            edad: 31,
            genero: 'masculino',
            orientacion_sexual: 'bisexual',
            url_fotoperfil: 'https://images.unsplash.com/photo-1552374196-c4e7ffc6e126?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80',
            foto_url_1: 'https://images.unsplash.com/photo-1552374196-c4e7ffc6e126?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80',
            foto_url_2: null,
            bio: 'Barista experto en café de especialidad y mixología.',
            intereses: 'Café, Mixología, Jazz',
            estudios_trabajo: 'Dueño de Cafetería'
        },

        // Nuevas participantes mujeres
        {
            cod_usuario: 708,
            nombre: 'Valeria Ríos',
            username: 'vrios_event1007',
            edad: 25,
            genero: 'femenino',
            orientacion_sexual: 'heterosexual',
            url_fotoperfil: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80',
            foto_url_1: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80',
            foto_url_2: null,
            bio: 'Psicóloga especializada en relaciones interpersonales.',
            intereses: 'Psicología, Teatro, Escritura Creativa',
            estudios_trabajo: 'Psicóloga Clínica'
        },
        {
            cod_usuario: 709,
            nombre: 'Camila Vega',
            username: 'cvega_event1007',
            edad: 27,
            genero: 'femenino',
            orientacion_sexual: 'bisexual',
            url_fotoperfil: 'https://images.unsplash.com/photo-1499952127939-9bbf5af6c51c?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80',
            foto_url_1: 'https://images.unsplash.com/photo-1499952127939-9bbf5af6c51c?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80',
            foto_url_2: null,
            bio: 'Influencer de fitness y nutrición saludable.',
            intereses: 'Fitness, Nutrición, Yoga',
            estudios_trabajo: 'Entrenadora Personal'
        },
        {
            cod_usuario: 710,
            nombre: 'Lucía Mendoza',
            username: 'lmendoza_event1007',
            edad: 29,
            genero: 'femenino',
            orientacion_sexual: 'heterosexual',
            url_fotoperfil: 'https://images.unsplash.com/photo-1589156280159-27698a70f29e?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80',
            foto_url_1: 'https://images.unsplash.com/photo-1589156280159-27698a70f29e?ixlib=rb-1.2.1&auto=format&fit=crop&w=300&q=80',
            foto_url_2: null,
            bio: 'Piloto comercial apasionada por la aviación y los viajes.',
            intereses: 'Aviación, Turismo, Idiomas',
            estudios_trabajo: 'Piloto Comercial'
        }
    ],
    ...
    1005: [
        ...
        {
            cod_usuario: 503, nombre: 'Alex Chen', username: 'achen_event1005', edad: 29, genero: 'otro', orientacion_sexual: 'otro', // Assuming 'pansexual' would fall under 'otro' or you'd extend the enum
...
export default function MatchScreen() {
    ...
    if (index >= participants.length) {
        return (
            <View style={styles.centered}>
                <Text style={styles.noMore}>No quedan más participantes en el evento por ahora.</Text>
                <TouchableOpacity onPress={() => router.back()} style={styles.backButtonBottom}>
                    <MaterialCommunityIcons name="arrow-left" size={30} color="#fff" />
